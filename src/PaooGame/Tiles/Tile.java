...
public class Tile
{
    ...
    public static Tile perete1          =new Perete1(0);
    public static Tile floorTile1          =new FloorTile1(1);
    public static Tile normalDoor          =new NormalDoor(2);
    public static Tile rock1          =new MountainTile(3);
    public static Tile isaac1          =new Isaac1(4);
    public static Tile monstro1          =new Monstro1(5);
